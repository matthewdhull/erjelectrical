...
#import "HotBus2TableController.h"
#import "BusListCustomCell.h"


@implementation HotBus2TableController
@synthesize hotBus2List;
...
- (void)viewDidLoad {
    ...
    NSString *plistPath = [bundle pathForResource: @"HotBus2" ofType: @"plist"];
    NSMutableArray *array = [[NSMutableArray alloc] initWithContentsOfFile: plistPath];
    [array sortedArrayUsingSelector: @selector(compare:)];
    self.hotBus2List = array;
    [array release];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.titleLabel.text = [hotBus2List objectAtIndex: row];
    cell.detailLabel.text = @"Hot Bus 2";
